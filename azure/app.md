...
Click on New pipeline button (or Create Pipeline if you don't have other pipelines previously created)
...
Select the main branch and the /.ado/eshoponweb-ci-docker.yml file, then click on Continue
...
Review the pipeline definition. The CI definition consists of the following tasks:
...
Open the pipeline execution. If you see a warning message "This pipeline needs permission to access a resource before this run can continue to Build", click on View and then Permit and Permit again. This will allow the pipeline to access the Azure subscription.
...
Select the main branch and the /.ado/eshoponweb-cd-webapp-docker.yml file, then click on Continue
...
Review the pipeline definition. The CD definition consists of the following tasks:
...
Open the pipeline execution. If you see a warning message "This pipeline needs permission to access a resource before this run can continue to Deploy", click on View and then Permit and Permit again. This will allow the pipeline to access the Azure subscription.
...
Verify that the eShopOnWeb application is running successfully. Once confirmed, you have completed the lab successfully.
