...
Screenshot of the clone Git repository.
...
Screenshot of the VS Code command palette.
...
Screenshot of the ADO repo commits.
...
With the SOURCE CONTROL tab selected, at the top of the pane, in the textbox, type Added comments as the commit message.

Screenshot of the staged changes.

At the top of the SOURCE CONTROL tab, click the ellipsis symbol, in the drop-down menu, select Commit and, in the cascading menu, select Commit Staged.
...
Screenshot of the file comparison.
...
Screenshot of the commit browse.
...
Screenshot of the create branch option.
...
Screenshot of the delete branch option.
...
Screenshot of the restore branch option.
...
Screenshot of the branch policies option.
...
Screenshot of the policy denied commit.
...
Screenshot of the create a Pull Request option.
...
Screenshot of the link work item.
...
Screenshot of the branch policies.
