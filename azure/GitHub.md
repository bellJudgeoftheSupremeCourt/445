...
If you don't already have a GitHub account, create one . Identify any affiliations in your GitHub profile.
...
⚠️ This option is encouraged for people with no Git/GitHub experience, same process could be manually followed: GitHub, working with forks
...
⚠️ If the Pull Request is related to an issue that has not been reported yet, please report it, following the previously mentioned steps.
...
Github Repo showing images folder

On the lab specific folder, screenshots will be saved on the following format (PNG) and naming: [descriptive_name]_[versionnumber].png, for example, create_epic_v1.png
...
⚠️ Image could be resized using the following syntax example, modifying with to your needs: [<img src="images/m1/child_feature_v1.png" alt="Include Title 'Training Dashboard' and click 'OK' " width="500"/>]()
...
Snagit is a great tool for capturing screen that provides us with useful tools for the functionality we want to add to our screenshots.
...
blur properties  red rectangle properties steps properties

Example:

In the "interations" tab, click on "Select Iteration"
